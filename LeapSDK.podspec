Pod::Spec.new do |spec|
  ...
  spec.description              = <<-DESC
                                  ...
                                  DESC
  spec.homepage                 = 'https://leap.liquid.ai'
  spec.license                  = { :type => 'Proprietary', :text => 'Copyright 2025 Liquid AI. All rights reserved.' }
  spec.author                   = { 'Liquid AI' => 'support@liquid.ai' }
  spec.source                   = { :http => 'https://github.com/Liquid4All/leap-ios/releases/download/v1.0.0/LeapSDK.xcframework.zip' }
  ...
  # Documentation
  spec.documentation_url        = 'https://leap.liquid.ai/docs/ios/ios-quick-start-guide'
